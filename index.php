...
<body>
    ...
    ?>
    <main>
        <section class="container-fluid d-flex justify-content-center align-items-center" style="height: 35em;background:linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.65)), url(img/situdaun1.jpg); background-repeat: no-repeat; background-size: cover;">
        ...
        <section style="background-color:#dfe8e4;">
            <div class="container-fluid p-5 ">
                <div class="mb-4">
                    <h1 class="fs-3 text-center fw-semibold"><i class="fa-regular fa-newspaper" style="color: #001121;"></i> &nbsp; Berita Terkini</h1>
                </div>
        ...
        <section class="mb-5">
            <div class="container-fluid p-5 ">
                <div class="mb-4">
                    <h1 class="fs-3 text-center fw-semibold"><i class="fa-solid fa-location-dot" style="color: #001121;"></i> &nbsp; Lokasi</h1>
                </div>
                <div class="d-flex justify-content-center">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13131.57679597979!2d106.70296943959438!3d-6.620713538040215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69dabb95a0136b%3A0x5a07f4ab9ba6ff92!2sSitu%20Daun%2C%20Kec.%20Tenjolaya%2C%20Kabupaten%20Bogor%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1689249602816!5m2!1sid!2sid" width="1200" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
