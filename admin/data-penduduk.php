    ...
    <div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="d-flex justify-content-between" style="padding: 0 20px;">
                <form class="d-flex justify-content-between col-4 p-0" method="get">
                    <input type="hidden" name="p" value="data-penduduk">
                        ...
                        <tbody>
                            ...
                            <?php while ($penduduk = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?p=edit-data-penduduk&id=<?= $penduduk['id_penduduk']; ?>" class="btn btn-primary">
